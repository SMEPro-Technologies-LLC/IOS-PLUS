-- ============================================================
-- IOS+ COS+ Database — V3 RAG Vault Tables
...
-- ── rag_chunks (partitioned by sector_code) ──────────────────
...
-- ── HNSW Indexes (per sector partition) ──────────────────────
...
CREATE INDEX idx_hnsw_01_energy   ON rag_chunks_01_energy        USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_02_health   ON rag_chunks_02_healthcare     USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_03_finance  ON rag_chunks_03_finance        USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_04_food     ON rag_chunks_04_food_drug_ag   USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_05_mfg      ON rag_chunks_05_mfg_transport  USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_06_telecom  ON rag_chunks_06_telecom        USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_07_ins      ON rag_chunks_07_insurance      USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_08_re       ON rag_chunks_08_real_estate    USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_09_ag       ON rag_chunks_09_agriculture    USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_10_mining   ON rag_chunks_10_mining         USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_11_retail   ON rag_chunks_11_retail         USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_12_prof     ON rag_chunks_12_prof_svcs      USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_13_edu      ON rag_chunks_13_education      USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_14_arts     ON rag_chunks_14_arts           USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_15_accom    ON rag_chunks_15_accom_food     USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_16_admin    ON rag_chunks_16_admin_waste    USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_17_other    ON rag_chunks_17_other_svcs     USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_18_pub      ON rag_chunks_18_pub_admin      USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_19_mgmt     ON rag_chunks_19_mgmt_cos       USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
CREATE INDEX idx_hnsw_xsc         ON rag_chunks_xsc               USING hnsw (embedding vector_cosine_ops) WITH (m=16, ef_construction=200);
