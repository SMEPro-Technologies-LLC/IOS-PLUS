...
POLICY_NAME="${POLICY_NAME:-ios-plus-policy}"
POLICY_FILE="${POLICY_FILE:-infra/vault/ios-plus-policy.hcl}"
ROLE_NAME="${ROLE_NAME:-ios-plus-role}"
KEY_NAME="${KEY_NAME:-ios-evidence-signing}"
